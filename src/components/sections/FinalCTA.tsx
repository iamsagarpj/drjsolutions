...
export function FinalCTA() {
  ...
  return (
    <section className="relative isolate overflow-hidden">
      <Photo id="sky" sizes="100vw" className="absolute inset-0 size-full" />
      <div className="relative bg-navy-deep/55">
        <div className="wrap-wide py-12 text-center sm:py-16">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm text-white/80 sm:text-base">{t.home.finalBody}</p>
